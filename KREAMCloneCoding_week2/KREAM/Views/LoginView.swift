...
class LoginView: UIView {
    ...
    public lazy var KakaoLoginButton: UIButton = {
        ...
        btn.layer.cornerRadius = 10.0
        btn.layer.masksToBounds = true
        btn.setImage(UIImage(named: "Image.png.left"),for: .normal)
    ...
    public lazy var AppleLoginButton: UIButton = {
        ...
        btn.layer.cornerRadius = 10.0
        btn.layer.masksToBounds = true
        btn.setImage(UIImage(named: "AppleLogo.png.left"),for: .normal)
        btn.imageEdgeInsets = UIEdgeInsets(top: 0, left: 10, bottom: 0, right: 0)//작동이 안됩니다..
