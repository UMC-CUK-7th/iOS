...
class DummySavedModel {
    static let Productdata: [SavedModel] = [
        ...
        SavedModel(name:"절대반지", image:"Shoe.png",description:" 설명란",price:"1000,000,000원"),
        SavedModel(name:"Nike", image:"Shoe.png",description:" aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa  aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",price:"140,000원"),
        ...
        SavedModel(name:"과제", image:"Shoe.png",description:" 설명란",price:"1000,000,000원"),
        SavedModel(name:"짜증난다", image:"profile.png",description:" 설명란",price:"1000,000,000원")
        ]
}
