...
class SearchTextView: UIView {
    ...
    private func setupUI() {
        ...
        self.addSubviews(searchTextField, cancleLabel, chucheonLabel, chucheonCollectionView)
        setupConstraints()
    }
    ...
    private func setupConstraints() {
        ...
        cancleLabel.snp.makeConstraints { make in
            ...
            make.leading.equalTo(searchTextField.snp.trailing).offset(11)
        }
        
        chucheonLabel.snp.makeConstraints { make in
            make.top.equalTo(searchTextField.snp.bottom).offset(41)
            make.leading.equalToSuperview().offset(16)
        }
